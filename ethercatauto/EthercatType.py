...
dictEthercatType = {
    'BOOL': ('UINT8',       'DEFTYPE_BOOLEAN',      1),
    'BYTE': ('UINT8',       'DEFTYPE_UNSIGNED8',    1),
    'BIT1': ('UINT8',       'DEFTYPE_BIT1',         1),
    'BIT2': ('UINT8',       'DEFTYPE_BIT2',         2),
    'BIT3': ('UINT8',       'DEFTYPE_BIT3',         3),
    'BIT4': ('UINT8',       'DEFTYPE_BIT4',         4),
    'BIT5': ('UINT8',       'DEFTYPE_BIT5',         5),
    'BIT6': ('UINT8',       'DEFTYPE_BIT6',         6),
    'BIT7': ('UINT8',       'DEFTYPE_BIT7',         7),
    'BIT8': ('UINT8',       'DEFTYPE_BIT8',         8),
    'SINT': ('INT8',        'DEFTYPE_INTEGER8',     8),
    ...
    'USINT': ('UINT8',      'DEFTYPE_UNSIGNED8',    8),
