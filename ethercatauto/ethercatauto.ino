...
char DEVICE_NAME[] = "MiscDevice";
UINT8 DEVICE_NAME_LEN = 10;
...
={8, {0x70000120,0x70000220,0x70000320,0x70000420,0x70010103,0x70010201,0x70010305,0x00000007,}};
...
={7, {0x60000108,0x00000008,0x60000220,0x60000303,0x60000401,0x60000505,0x00000007,}};
...
={5,0,0,0,0,0,};
OBJCONST TSDOINFOENTRYDESC OBJMEM asEntryDesc0x6000[6] = {
	...
	{DEFTYPE_UNSIGNED32, 32, ACCESS_READ|ACCESS_WRITE|OBJACCESS_TXPDOMAPPING},
	{DEFTYPE_BIT3, 3, ACCESS_READ|ACCESS_WRITE|OBJACCESS_TXPDOMAPPING},
	{DEFTYPE_BOOLEAN, 1, ACCESS_READ|ACCESS_WRITE|OBJACCESS_TXPDOMAPPING},
	{DEFTYPE_BIT5, 5, ACCESS_READ|ACCESS_WRITE|OBJACCESS_TXPDOMAPPING},
};
OBJCONST UCHAR OBJMEM aName0x6000[] = "\000\000\000\000\000\000\377";
/****************************************************
** Object0x6010
****************************************************/
typedef struct OBJ_STRUCT_PACKED_START {
...
={1,0,};
OBJCONST TSDOINFOENTRYDESC OBJMEM asEntryDesc0x6010[2] = {
	{DEFTYPE_INTEGER16, 16, ACCESS_READ|ACCESS_WRITE|OBJACCESS_NOPDOMAPPING},
	{DEFTYPE_UNSIGNED16, 16, ACCESS_READ|ACCESS_WRITE|OBJACCESS_TXPDOMAPPING},
};
OBJCONST UCHAR OBJMEM aName0x6010[] = "\000\000\377";
/****************************************************
** Object0x7000
****************************************************/
typedef struct OBJ_STRUCT_PACKED_START {
...
OBJCONST TSDOINFOENTRYDESC OBJMEM asEntryDesc0x7000[2] = {
	...
	{DEFTYPE_INTEGER32, 32, ACCESS_READ|ACCESS_WRITE|OBJACCESS_RXPDOMAPPING},
};
OBJCONST UCHAR OBJMEM aName0x7000[] = "Output";
/****************************************************
** Object0x7001
****************************************************/
typedef struct OBJ_STRUCT_PACKED_START {
...
={3,0,0,0,};
OBJCONST TSDOINFOENTRYDESC OBJMEM asEntryDesc0x7001[4] = {
	{DEFTYPE_INTEGER16, 16, ACCESS_READ|ACCESS_WRITE|OBJACCESS_NOPDOMAPPING},
	{DEFTYPE_BIT3, 3, ACCESS_READ|ACCESS_WRITE|OBJACCESS_RXPDOMAPPING},
	{DEFTYPE_BOOLEAN, 1, ACCESS_READ|ACCESS_WRITE|OBJACCESS_RXPDOMAPPING},
	{DEFTYPE_BIT5, 5, ACCESS_READ|ACCESS_WRITE|OBJACCESS_RXPDOMAPPING},
};
OBJCONST UCHAR OBJMEM aName0x7001[] = "\000\000\000\000\377";
/****************************************************
** Object0x8000
****************************************************/
...
TOBJECT    OBJMEM ApplicationObjDic[] = {
	...
	{NULL, NULL, 0x6010, {DEFTYPE_RECORD, 1|(OBJCODE_REC<<8)}, asEntryDesc0x6010, aName0x6010, &Obj0x6010, NULL , NULL , 0x0000 },
	{NULL, NULL, 0x7000, {DEFTYPE_RECORD, 4|(OBJCODE_ARR<<8)}, asEntryDesc0x7000, aName0x7000, &Obj0x7000, NULL , NULL , 0x0000 },
	{NULL, NULL, 0x7001, {DEFTYPE_RECORD, 3|(OBJCODE_REC<<8)}, asEntryDesc0x7001, aName0x7001, &Obj0x7001, NULL , NULL , 0x0000 },
